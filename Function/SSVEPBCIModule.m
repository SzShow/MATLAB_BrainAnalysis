classdef SSVEPBCIModule
    ...
    methods
        ...
        function obj=SSVEPBCIModule(eeg, TriggerTable, fs, ts, offset)
            [nele, nt]=size(eeg);
            ...
            obj.RawData=eeg(1:nele-1, Start:Start+obj.Ns-1)';
        ...
        function obj=SetEEGBuffer(obj, buf)
            obj.Buffer=buf;
            obj.WindowLength=buf.WindowLength;
            obj.Overlap=buf.Overlap;
        end
        
        function obj=SetPreProcessor(obj, pp)
            obj.PreProcessor=pp;
        end
